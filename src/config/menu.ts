...
export const menuConfig: MenuConfig = {
  ...
  agency_admin: [
    {
      label: 'Dashboard',
      description: 'Agency performance overview and key metrics',
      icon: LayoutDashboard,
      path: '/agency',
    },
    {
      label: 'Opportunities',
      description: 'Find and respond to shift requests from employers',
      icon: Search,
      children: [
        {
          label: 'Available Requests',
          description: 'Browse open shift requests from employers',
          icon: ClipboardList,
        ...
        {
          label: 'My Responses',
          description: 'Manage your shift request responses',
          icon: FileCheck,
          path: '/agency/agency-responses',
          permission: 'agency_response:view',
        },
        {
          label: 'Quick Match',
          description:
            'AI-powered automated matching of your employees to suitable shifts',
          icon: Zap,
    ...
    },
    {
      ...
      description: 'Manage agency employees and registrations',
      icon: Users,
      children: [
        {
          label: 'Employee Roster',
          description: 'Manage employees registered with your agency',
          icon: Users,
          path: '/agency/agency-employees',
          permission: 'agency_employee:view',
        },
        {
          label: 'Register Employee',
          description: 'Register new employees with agency-specific terms',
          icon: UserCheck,
          path: '/agency/agency-employees/register',
          permission: 'agency_employee:create',
        },
        {
          label: 'Employee Availability',
          description: 'View employee availability across all agencies',
          icon: CalendarRange,
        ...
        },
        {
          ...
          description: 'Monitor employee performance metrics',
          icon: Target,
    ...
    },
    {
      ...
      description: 'Manage internal agency staff and settings',
      icon: Building,
      children: [
        {
          label: 'Agent Management',
          description: 'Manage agency staff and permissions',
          icon: UserCog,
          path: '/agency/agents',
        ...
        },
        {
          ...
          description: 'Manage agency branches and locations',
          icon: MapPin,
        ...
        },
        {
          ...
          description: 'Manage agency information and branding',
          icon: Building,
          path: '/agency/profile',
          permission: 'agency:view',
        },
    ...
    {
      label: 'Assignments & Contracts',
      description: 'Manage active assignments and employer contracts',
      icon: Link,
      children: [
        {
          label: 'Assignments',
          description: 'View and manage all employee assignments',
          icon: Link,
        ...
        },
        {
          ...
          description: 'Manage active employer-agency contracts',
          icon: FileCheck,
          path: '/agency/employer-contracts',
          permission: 'employer_agency_contract:view',
        },
        {
          label: 'Assignment Analytics',
          description: 'Performance metrics and insights for all assignments',
          icon: BarChart3,
          path: '/agency/assignment-analytics',
          permission: 'assignment:view',
        },
      ],
    },
    {
      ...
      description: 'Manage shifts within active assignments',
      icon: Calendar,
      children: [
        {
          label: 'Shift Calendar',
          description: 'Visual schedule management across assignments',
          icon: CalendarDays,
        ...
        {
          label: 'All Shifts',
          description: 'Comprehensive shift management view',
          icon: Calendar,
          path: '/agency/shifts',
          permission: 'shift:view',
        },
        {
          label: 'Shift Offers',
          description: 'Offer shifts to agency employees',
          icon: Workflow,
          path: '/agency/shift-offers',
          permission: 'shift_offer:view',
        },
        {
          label: 'Shift Templates',
          description: 'Create recurring shift patterns',
          icon: Copy,
          path: '/agency/shift-templates',
    ...
    },
    {
      ...
      description: 'Manage time off and global availability',
      icon: Clock4,
      children: [
        {
          label: 'Time Off Requests',
          description: 'Approve employee time off requests',
          icon: Clock,
        ...
        },
        {
          ...
          description: 'View employee availability across all agencies',
          icon: Eye,
          path: '/agency/global-availability',
          permission: 'availability:view',
        },
      ],
    },
    {
      ...
      description: 'Monitor timesheet submission and approval workflow',
      icon: Clock,
      children: [
        {
          label: 'Pending Timesheets',
          description: 'Review employee timesheet submissions',
          icon: FileText,
          path: '/agency/timesheets/pending',
          permission: 'timesheet:view',
        },
        {
          label: 'Agency Approval',
          description: 'Approve timesheets before employer review',
          icon: CheckSquare,
          path: '/agency/timesheets/agency-approval',
          permission: 'timesheet:agency_approve',
        },
        {
          label: 'Approval History',
          description: 'View timesheet approval records',
          icon: History,
    ...
    },
    {
      ...
      description: 'Manage billing, payroll, and financial reporting',
      icon: PoundSterling,
      children: [
        {
          label: 'Client Invoicing',
          description: 'Create invoices for employer clients',
          icon: Receipt,
        ...
        },
        {
          ...
          description: 'Process payroll for agency employees',
          icon: Calculator,
          path: '/agency/payroll',
        ...
        },
        {
          ...
          description: 'Manage employee payouts and batches',
          icon: Banknote,
          path: '/agency/payouts',
        ...
        },
        {
          ...
          description: 'View agency revenue and financial performance',
          icon: BarChart3,
          path: '/agency/revenue-analytics',
    ...
    },
    {
      ...
      description: 'Manage pricing and rate cards',
      icon: CreditCard,
      children: [
        {
          label: 'Rate Cards',
          description: 'Manage agency rate cards and pricing',
          icon: CreditCard,
        ...
        },
        {
          ...
          description: 'Configure default markup percentages',
          icon: Percent,
          path: '/agency/markup-settings',
    ...
    },
    {
      ...
      description: 'Configure agency profile and operations',
      icon: Settings,
      children: [
        {
          label: 'Billing & Subscription',
          description: 'Manage platform subscription and billing',
          icon: CreditCard,
          path: '/agency/billing',
          permission: 'agency:view',
        },
        {
          ...
          description: 'View platform commission and fees',
          icon: Coins,
        ...
        },
        {
          ...
          description: 'Configure agency notification preferences',
          icon: Bell,
